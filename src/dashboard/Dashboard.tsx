		...
		<>
			...
			<header className="pt-4 pb-6 bg-white">
				<div>
					...
					>
						...
						<p className="text-gray-600 md:px-20 mt-4">
							...
							urna purus ut scelerisque. Cursus quam non purus gravida commodo
							at gravida. Aliquet ut et nisi ipsum in. Faucibus eu bibendum
							turpis.
						</p>
					</div>
					...
					<div
						...
						className="Section-2 md:h-60 h-48 bg-center bg-cover"
					>
						<div className=" mt-8 relative">
							
							<div className="flex justify-center space-x-6 absolute top-0 left-0 right-0">
							<Link to="/home">
				...
				<div className="Section-2 flex flex-col md:flex-row justify-between p-6">
					<div className="flex md:justify-start justify-center flex-col md:items-start items-center p-10 w-full md:w-1/2">
						<h1 className="md:text-[48px] text-[32px] font-bold mb-4 md:text-start text-center">
							AI-Powered Visual Content Creation
						</h1>
						<p className="text-[16px] md:text-[28px] md:text-start text-center">
							Automatically generate visually appealing presentations from your
							ideas.
						</p>
					</div>
				...
				<div className="Section-3 flex flex-col md:flex-row justify-between p-6">
					...
					<div className="flex order-1 md:order-2 justify-start flex-col items-start p-6 md:p-10 md:w-1/2">
						<h1 className="md:text-[48px] text-[32px] font-bold mb-4 md:text-start text-center">
				...
				<div className="Section-6 flex flex-col md:flex-row justify-between p-6">
					<div className="flex justify-center flex-col items-start p-10 w-full md:w-1/2">
						...
						<p className="text-[16px] md:text-[28px] md:text-start text-center">
							Collaborate with others in real-time, with instant feedback
							visibility.
						</p>
					</div>
					<div className="w-full md:w-1/2">
			...
			<div className="info py-16 flex flex-col items-center">
				<h1 className="md:text-[48px] text-[32px] mb-4 font-bold">
					Get Started for Free
				</h1>
				<p className="md:text-[22px] md:px-40 md:text-start text-center px-16">
					Lorem, ipsum dolor sit amet consectetur adipisicing elit. Natus alias
					saepe blanditiis eum quas error at, velit
				</p>
				<div className="btns flex items-center justify-center pt-4 space-x-4">
					<button className="bg-black text-white p-4 rounded-2xl">
						Learn More
					</button>
					<button className="bg-[#FF7F50] text-white p-4 rounded-2xl">
						Sign Up for Free →{" "}
					</button>
				</div>
			</div>
